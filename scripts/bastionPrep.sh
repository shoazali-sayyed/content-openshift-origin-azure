...
wget https://github.com/shoazali-sayyed/content-openshift-origin-azure/tree/master/ssh/id_rsa -P /home/azureuser/.ssh/

wget https://github.com/shoazali-sayyed/content-openshift-origin-azure/tree/master/ssh/id_rsa.pub -P /home/azureuser/.ssh/
